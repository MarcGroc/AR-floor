...
class PathManager:
    ...
    def check_battery_level(self, robot: Robot, layout) -> None:
    ...
    def get_shelve_path(
        self, target_location: list[int, int], robot: Robot, layout
    ) -> Robot:
    ...
    def get_path_to_empty_location(
        self,  robot: Robot, layout
    ):
    ...
    def get_path_to_charging_station(self, robot: Robot, layout):
